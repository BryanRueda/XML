...
#-------------------------------------------------------------------------------
    ...
    if len(elements)>0:
        ...
        Headers = [ "No. Id.","Agente de Retención","Tipo Comprobante","Establecimiento","Punto Emisión","Secuencial","Numero de Autorizacion","Clave de Acceso","Fecha Emisión",
